        ...
        },
        {
            "ColorScheme",
            {
                ...
                callback = function()
                    ...
                    vim.api.nvim_set_hl(0, 'LineNrAbove', { fg = '#51B3EC', bold = true, italic = true })
                    vim.api.nvim_set_hl(0, 'LineNr', { fg = 'white', bold = true, italic = true })
                    vim.api.nvim_set_hl(0, 'LineNrBelow', { fg = '#1B6B93', bold = true, italic = true })
